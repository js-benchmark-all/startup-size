...
const invalids = [
  ...
  { id: 8, displayName: "ValidName", health: 50, inventory: new Array(31).fill({ id: 1, displayName: "sword" }) },
  ...
  { id: 12, health: 50, inventory: [{ id: 13, displayName: "anamethatisverylongandshouldnotpassdisplaynamecheck" }] },
